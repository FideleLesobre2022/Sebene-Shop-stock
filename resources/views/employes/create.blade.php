        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card border-top border-0 border-4 border-danger">
                <div class="card-body p-5">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('employes.store') }}">
                        @method('POST')
                        @csrf
                        ...
                        <div class="col-md-6">
                            <label for="prenom" class="form-label text-uppercase">Prénom</label>
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        class='bx bxs-user'></i></span>
                                <input name="prenom_employe" type="text" class="form-control border-start-0"
                                    id="prenom" placeholder="Franck" />
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                ...
                                <input type="text" class="form-control border-start-0" id="inputPhoneNo"
                                    placeholder="Kinshasa" name="ville_employe" />
                            </div>
                            @error('ville_employe')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                ...
                                <input type="number" class="form-control border-start-0" id="inputPhoneNo"
                                    placeholder="10092" name="codepostal_employe" />
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                ...
                                <input type="tel" class="form-control border-start-0" id="inputPhoneNo"
                                    placeholder="Phone No" name="telephone_employe" />
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                ...
                                <input type="text" class="form-control border-start-0" id="inputPhoneNo"
                                    placeholder="Manager" name="poste_employe" />
                            </div>
                            @error('poste_employe')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                ...
                                <input type="number" class="form-control border-start-0" id="inputPhoneNo"
                                    placeholder="100.000" name="salaire_employe" />
                            </div>
